...
class App extends React.Component {
    ...
    handlePlayPause = () => {
        ...
        if(isPlaying) {
            ...
            this.loop = setInterval(() => {
                const { 
                    clockCount, currentTimer, breakCount, sessionCount 
                } = this.state;
    ...
    handleLengthChange = (count, timerType) => {
        const { 
            sessionCount, breakCount, isPlaying, currentTimer
        } = this.state;
...
//  handleBreakDecrease = () => {
//      const { 
//          breakCount, isPlaying, currentTimer 
//      } = this.state;
...
//      const { 
//          sessionCount, isPlaying, currentTimer 
//      } = this.state;
...
//  }
    ...
    render() {
        const { 
            breakCount, sessionCount, clockCount, currentTimer, isPlaying 
        } = this.state;
